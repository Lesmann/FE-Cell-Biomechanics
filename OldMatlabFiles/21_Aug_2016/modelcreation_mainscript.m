...
close all
clear all
rmdir('E:\Ran\Cell-ECM_model_2D_1_cell\csvFiles','s');
mkdir('E:\Ran\Cell-ECM_model_2D_1_cell\csvFiles');
clc
...
for i = 1 : ll
    for j = 1 : lr
        ...
        Nodes = apply_circ_cells(ic, circNodes, Nodes);
        ...
        if strcmp(config.modelType,'FBC')==1
