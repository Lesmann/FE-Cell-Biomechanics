...
%     or acoustic pressure output is 108. See section < < Results file output
...
ind = strfind(Rec,'I 3108I'); % record key for node pore or acoustic pressure output (108)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 3108')+1;
for i=1:numel(ind)
    % check the record
