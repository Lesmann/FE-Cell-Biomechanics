function out = Rec105(Rec)
%
% ABAQUS electrical potential output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec105(#Rec#)
%
% Description
%     Read electrical potential output from the results (*.fil) file
...
%     electrical potential output is 105. See section < < Results file output
...
%     contain electrical potential results:
%         ...
%         *FILE FORMAT, ASCII
%         *NODE FILE
%         EPOT
...
ind = strfind(Rec,'I 3105I'); % record key for node electrical potential output (105)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 3105')+1;
for i=1:numel(ind)
    % check the record
