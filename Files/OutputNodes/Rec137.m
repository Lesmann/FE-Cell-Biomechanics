function out = Rec137(Rec)
%
% ABAQUS fluid cavity volume output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec137(#Rec#)
%
% Description
%     Read fluid cavity volume output from the results (*.fil) file
...
%     cavity volume output is 137. See section < < Results file output
...
%     contain fluid cavity volume results:
%         ...
%         *FILE FORMAT, ASCII
%         *NODE FILE
%         CVOL
...
ind = strfind(Rec,'I 3137I'); % record key for node fluid cavity volume output (137)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 3137')+1;
for i=1:numel(ind)
    % check the record
