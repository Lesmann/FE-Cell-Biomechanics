%% COORDINATE output from Abaqus to Matlab (Record key 8)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\8.inp'],[S(1:a(end)-1),'\8.inp'],'f')
%%
% Run the input file 8.inp with Abaqus
!abaqus job=8
%%
