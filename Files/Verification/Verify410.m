%% PRINCIPAL THERMAL STRAINS output from Abaqus to Matlab (Record key 410)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\410.inp'],[S(1:a(end)-1),'\410.inp'],'f')
%%
% Run the input file 410.inp with Abaqus
!abaqus job=410
%%
