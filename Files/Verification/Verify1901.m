%% NODE DEFINITION output from Abaqus to Matlab (Record key 1901)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\1901.inp'],[S(1:a(end)-1),'\1901.inp'],'f')
%%
% Run the input file 1901.inp with Abaqus
!abaqus job=1901
%%
