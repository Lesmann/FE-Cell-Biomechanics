%% REACTION FORCE output from Abaqus to Matlab (Record key 104)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\104.inp'],[S(1:a(end)-1),'\104.inp'],'f')
%%
% Run the input file 104.inp with Abaqus
!abaqus job=104
%%
