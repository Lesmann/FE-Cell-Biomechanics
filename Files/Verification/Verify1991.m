%% J-INTEGRAL output from Abaqus to Matlab (Record key 1991)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\1991.inp'],[S(1:a(end)-1),'\1991.inp'],'f')
%%
% Run the input file 1991.inp with Abaqus
!abaqus job=1991
%%
