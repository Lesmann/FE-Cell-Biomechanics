%% UNIT NORMAL TO CRACK IN CONCRETE output from Abaqus to Matlab (Record key 26)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\26.inp'],[S(1:a(end)-1),'\26.inp'],'f')
%%
% Run the input file 26.inp with Abaqus
!abaqus job=26
%%
