%% PRINCIPAL STRESSES output from Abaqus to Matlab (Record key 401)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\401.inp'],[S(1:a(end)-1),'\401.inp'],'f')
%%
% Run the input file 401.inp with Abaqus
!abaqus job=401
%%
