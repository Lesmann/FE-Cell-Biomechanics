%% COORDINATE output from Abaqus to Matlab (Record key 107)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\107.inp'],[S(1:a(end)-1),'\107.inp'],'f')
%%
% Run the input file 107.inp with Abaqus
!abaqus job=107
%%
