%% ELECTRICAL POTENTIAL output from Abaqus to Matlab (Record key 105)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\105.inp'],[S(1:a(end)-1),'\105.inp'],'f')
%%
% Run the input file 105.inp with Abaqus
!abaqus job=105
%%
