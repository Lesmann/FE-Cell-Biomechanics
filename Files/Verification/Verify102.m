%% VELOCITY output from Abaqus to Matlab (Record key 102)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\102.inp'],[S(1:a(end)-1),'\102.inp'],'f')
%%
% Run the input file 102.inp with Abaqus
!abaqus job=102
%%
