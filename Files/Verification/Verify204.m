%% RESIDUAL FLUX output from Abaqus to Matlab (Record key 204)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\204.inp'],[S(1:a(end)-1),'\204.inp'],'f')
%%
% Run the input file 204.inp with Abaqus
!abaqus job=204
%%
