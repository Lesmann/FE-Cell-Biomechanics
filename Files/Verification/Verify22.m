%% PLASTIC STRAIN output from Abaqus to Matlab (Record key 22)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\22.inp'],[S(1:a(end)-1),'\22.inp'],'f')
%%
% Run the input file 22.inp with Abaqus
!abaqus job=22
%%
