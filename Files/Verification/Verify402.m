%% PRINCIPAL VALUES OF BACKSTRESS TENSOR FOR KINEMATIC HARDENING PLASTICITY output from Abaqus to Matlab (Record key 402)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\402.inp'],[S(1:a(end)-1),'\402.inp'],'f')
%%
% Run the input file 402.inp with Abaqus
!abaqus job=402
%%
