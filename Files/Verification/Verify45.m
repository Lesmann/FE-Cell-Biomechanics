%% EQUIVALENT PLASTIC STRAIN COMPONENTS output from Abaqus to Matlab (Record key 45)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\45.inp'],[S(1:a(end)-1),'\45.inp'],'f')
%%
% Run the input file 45.inp with Abaqus
!abaqus job=45
%%
