%% ELEMENT STATUS output from Abaqus to Matlab (Record key 61)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\61.inp'],[S(1:a(end)-1),'\61.inp'],'f')
%%
% Run the input file 61.inp with Abaqus
!abaqus job=61
%%
