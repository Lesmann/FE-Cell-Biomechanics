%% PORE FLUID EFFECTIVE VELOCITY VECTOR output from Abaqus to Matlab (Record key 97)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\97.inp'],[S(1:a(end)-1),'\97.inp'],'f')
%%
% Run the input file 97.inp with Abaqus
!abaqus job=97
%%
