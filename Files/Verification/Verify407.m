%% PRINCIPAL VALUES OF DEFORMATION GRADIENT output from Abaqus to Matlab (Record key 407)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\407.inp'],[S(1:a(end)-1),'\407.inp'],'f')
%%
% Run the input file 407.inp with Abaqus
!abaqus job=407
%%
