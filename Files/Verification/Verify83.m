%% AVERAGE SHELL SECTION STRESS output from Abaqus to Matlab (Record key 83)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\83.inp'],[S(1:a(end)-1),'\83.inp'],'f')
%%
% Run the input file 83.inp with Abaqus
!abaqus job=83
%%
