%% ELECTRICAL REACTION CURRENT output from Abaqus to Matlab (Record key 138)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\138.inp'],[S(1:a(end)-1),'\138.inp'],'f')
%%
% Run the input file 138.inp with Abaqus
!abaqus job=138
%%
