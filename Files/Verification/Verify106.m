%% POINT LOADS, MOMENTS, FLUXES output from Abaqus to Matlab (Record key 106)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\106.inp'],[S(1:a(end)-1),'\106.inp'],'f')
%%
% Run the input file 106.inp with Abaqus
!abaqus job=106
%%
