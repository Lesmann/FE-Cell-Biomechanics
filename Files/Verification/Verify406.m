%% PRINCIPAL MECHANICAL STRAIN RATES output from Abaqus to Matlab (Record key 406)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\406.inp'],[S(1:a(end)-1),'\406.inp'],'f')
%%
% Run the input file 406.inp with Abaqus
!abaqus job=406
%%
