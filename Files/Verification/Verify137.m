%% FLUID CAVITY VOLUME output from Abaqus to Matlab (Record key 137)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\137.inp'],[S(1:a(end)-1),'\137.inp'],'f')
%%
% Run the input file 137.inp with Abaqus
!abaqus job=137
%%
