%% SECTION THICKNESS output from Abaqus to Matlab (Record key 27)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\27.inp'],[S(1:a(end)-1),'\27.inp'],'f')
%%
% Run the input file 27.inp with Abaqus
!abaqus job=27
%%
