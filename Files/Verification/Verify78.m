%% WHOLE ELEMENT VOLUME output from Abaqus to Matlab (Record key 78)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\78.inp'],[S(1:a(end)-1),'\78.inp'],'f')
%%
% Run the input file 78.inp with Abaqus
!abaqus job=78
%%
