%% PRINCIPAL PLASTIC STRAINS output from Abaqus to Matlab (Record key 411)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\411.inp'],[S(1:a(end)-1),'\411.inp'],'f')
%%
% Run the input file 411.inp with Abaqus
!abaqus job=411
%%
