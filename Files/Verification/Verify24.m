%% TOTAL INELASTIC STRAIN output from Abaqus to Matlab (Record key 24)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\24.inp'],[S(1:a(end)-1),'\24.inp'],'f')
%%
% Run the input file 24.inp with Abaqus
!abaqus job=24
%%
