%% PRINCIPAL LOGARITHMIC STRAINS output from Abaqus to Matlab (Record key 405)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\405.inp'],[S(1:a(end)-1),'\405.inp'],'f')
%%
% Run the input file 405.inp with Abaqus
!abaqus job=405
%%
