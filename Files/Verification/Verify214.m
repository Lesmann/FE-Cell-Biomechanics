%% INTERNAL FLUX output from Abaqus to Matlab (Record key 214)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\214.inp'],[S(1:a(end)-1),'\214.inp'],'f')
%%
% Run the input file 214.inp with Abaqus
!abaqus job=214
%%
