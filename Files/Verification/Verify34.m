%% RADIATION output from Abaqus to Matlab (Record key 34)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\34.inp'],[S(1:a(end)-1),'\34.inp'],'f')
%%
% Run the input file 34.inp with Abaqus
!abaqus job=34
%%
