%% HEAT FLUX VECTOR output from Abaqus to Matlab (Record key 28)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\28.inp'],[S(1:a(end)-1),'\28.inp'],'f')
%%
% Run the input file 28.inp with Abaqus
!abaqus job=28
%%
