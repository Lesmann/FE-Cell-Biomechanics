%% TOTAL FLUID VOLUME RATIO output from Abaqus to Matlab (Record key 43)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\43.inp'],[S(1:a(end)-1),'\43.inp'],'f')
%%
% Run the input file 43.inp with Abaqus
!abaqus job=43
%%
