%% MOTIONS (IN CAVITY RADIATION ANALYSIS) output from Abaqus to Matlab (Record key 237)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\237.inp'],[S(1:a(end)-1),'\237.inp'],'f')
%%
% Run the input file 237.inp with Abaqus
!abaqus job=237
%%
