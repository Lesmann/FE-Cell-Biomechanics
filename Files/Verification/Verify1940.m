%% LABEL CROSS-REFERENCE output from Abaqus to Matlab (Record key 1940)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\1940.inp'],[S(1:a(end)-1),'\1940.inp'],'f')
%%
% Run the input file 1940.inp with Abaqus
!abaqus job=1940
%%
