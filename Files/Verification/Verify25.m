%% TOTAL ELASTIC STRAIN output from Abaqus to Matlab (Record key 25)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\25.inp'],[S(1:a(end)-1),'\25.inp'],'f')
%%
% Run the input file 25.inp with Abaqus
!abaqus job=25
%%
