%% ABAQUS ANALYSIS INFORMATION output from Abaqus to Matlab (Record key 1921)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\1921.inp'],[S(1:a(end)-1),'\1921.inp'],'f')
%%
% Run the input file 1921.inp with Abaqus
!abaqus job=1921
%%
