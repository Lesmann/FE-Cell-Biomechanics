%% ACCELERATION output from Abaqus to Matlab (Record key 103)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\103.inp'],[S(1:a(end)-1),'\103.inp'],'f')
%%
% Run the input file 103.inp with Abaqus
!abaqus job=103
%%
