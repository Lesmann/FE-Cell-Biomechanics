%% ENERGY (SUMMED OVER ELEMENT) output from Abaqus to Matlab (Record key 19)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\19.inp'],[S(1:a(end)-1),'\19.inp'],'f')
%%
% Run the input file 19.inp with Abaqus
!abaqus job=19
%%
