%% OUTPUT REQUEST DEFINITION output from Abaqus to Matlab (Record key 1911)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\1911.inp'],[S(1:a(end)-1),'\1911.inp'],'f')
%%
% Run the input file 1911.inp with Abaqus
!abaqus job=1911
%%
