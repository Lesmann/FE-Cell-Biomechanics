%% MASS CONCENTRATION (MASS DIFFUSION ANALYSIS) output from Abaqus to Matlab (Record key 38)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\38.inp'],[S(1:a(end)-1),'\38.inp'],'f')
%%
% Run the input file 38.inp with Abaqus
!abaqus job=38
%%
