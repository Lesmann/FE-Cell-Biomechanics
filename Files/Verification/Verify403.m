%% PRINCIPAL STRAINS output from Abaqus to Matlab (Record key 403)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\403.inp'],[S(1:a(end)-1),'\403.inp'],'f')
%%
% Run the input file 403.inp with Abaqus
!abaqus job=403
%%
