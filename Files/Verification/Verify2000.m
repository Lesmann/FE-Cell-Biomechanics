%% INCREMENT START RECORD output from Abaqus to Matlab (Record key 2000)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\2000.inp'],[S(1:a(end)-1),'\2000.inp'],'f')
%%
% Run the input file 2000.inp with Abaqus
!abaqus job=2000
%%
