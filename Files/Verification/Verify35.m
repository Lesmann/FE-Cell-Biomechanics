%% SATURATION (PORE PRESSURE ANALYSIS) output from Abaqus to Matlab (Record key 35)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\35.inp'],[S(1:a(end)-1),'\35.inp'],'f')
%%
% Run the input file 35.inp with Abaqus
!abaqus job=35
%%
