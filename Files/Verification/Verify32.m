%% STRAIN JUMP AT NODES output from Abaqus to Matlab (Record key 32)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\32.inp'],[S(1:a(end)-1),'\32.inp'],'f')
%%
% Run the input file 32.inp with Abaqus
!abaqus job=32
%%
