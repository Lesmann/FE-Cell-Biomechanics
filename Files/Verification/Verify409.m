%% PRINCIPAL INELASTIC STRAINS output from Abaqus to Matlab (Record key 409)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\409.inp'],[S(1:a(end)-1),'\409.inp'],'f')
%%
% Run the input file 409.inp with Abaqus
!abaqus job=409
%%
