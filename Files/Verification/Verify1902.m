%% ACTIVE DEGREES OF FREEDOM output from Abaqus to Matlab (Record key 1902)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\1902.inp'],[S(1:a(end)-1),'\1902.inp'],'f')
%%
% Run the input file 1902.inp with Abaqus
!abaqus job=1902
%%
