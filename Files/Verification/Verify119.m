%% ELECTRICAL REACTION CHARGE output from Abaqus to Matlab (Record key 119)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\119.inp'],[S(1:a(end)-1),'\119.inp'],'f')
%%
% Run the input file 119.inp with Abaqus
!abaqus job=119
%%
