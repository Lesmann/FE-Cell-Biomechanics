%% CONCENTRATED ELECTRICAL NODAL CURRENT output from Abaqus to Matlab (Record key 139)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\139.inp'],[S(1:a(end)-1),'\139.inp'],'f')
%%
% Run the input file 139.inp with Abaqus
!abaqus job=139
%%
