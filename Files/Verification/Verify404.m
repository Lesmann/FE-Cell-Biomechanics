%% PRINCIPAL NOMINAL STRAINS output from Abaqus to Matlab (Record key 404)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\404.inp'],[S(1:a(end)-1),'\404.inp'],'f')
%%
% Run the input file 404.inp with Abaqus
!abaqus job=404
%%
