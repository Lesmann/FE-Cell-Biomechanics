%% STRESS output from Abaqus to Matlab (Record key 11)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\11.inp'],[S(1:a(end)-1),'\11.inp'],'f')
%%
% Run the input file 11.inp with Abaqus
!abaqus job=11
%%
