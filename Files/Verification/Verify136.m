%% FLUID CAVITY PRESSURE output from Abaqus to Matlab (Record key 136)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\136.inp'],[S(1:a(end)-1),'\136.inp'],'f')
%%
% Run the input file 136.inp with Abaqus
!abaqus job=136
%%
