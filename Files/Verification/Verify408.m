%% PRINCIPAL ELASTIC STRAINS output from Abaqus to Matlab (Record key 408)
...
copyfile([S(1:a(end)-1),'\AbaqusInputFiles\408.inp'],[S(1:a(end)-1),'\408.inp'],'f')
%%
% Run the input file 408.inp with Abaqus
!abaqus job=408
%%
