function out = Rec408(Rec)
%
% ABAQUS principal elastic strains output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec408(#Rec#)
%
% Description
%     Read principal elastic strains output from the results (*.fil) file
...
%     principal elastic strains output is 408. See section < < Results file
...
%     contain principal elastic strain results:
%         ...
%         *FILE FORMAT, ASCII
%         *EL FILE
%         EEP
...
%         the record key 408 as follows:
%         Column  1  -  Minimum principal elastic strain. 
%         Column  2  -  Etc.
...
ind = strfind(Rec,'I 3408D'); % record key for element principal elastic strains output (408)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 3408')+1;
...
for i=1:numel(ind)
    ...
    % Element principal elastic strains
    for j=1:NW(i)-2
