function out = Rec404(Rec)
%
% ABAQUS principal nominal strains output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec404(#Rec#)
%
% Description
%     Read principal nominal strains output from the results (*.fil) file
...
%     principal nominal strains output is 404. See section < < Results file
...
%     contain principal nominal strain results:
%         ...
%         *FILE FORMAT, ASCII
%         *EL FILE
%         NEP
...
%         the record key 404 as follows:
%         Column  1  -  Minimum principal nominal strain. 
%         Column  2  -  Etc.
...
ind = strfind(Rec,'I 3404D'); % record key for element principal nominal strains output (404)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 3404')+1;
...
for i=1:numel(ind)
    ...
    % Element principal nominal strains
    for j=1:NW(i)-2
        % principal nominal strain
