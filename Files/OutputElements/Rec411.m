function out = Rec411(Rec)
%
% ABAQUS principal plastic strains output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec411(#Rec#)
%
% Description
%     Read principal plastic strains output from the results (*.fil) file
...
%     principal plastic strains output is 411. See section < < Results file
...
%     contain principal plastic strain results:
%         ...
%         *FILE FORMAT, ASCII
%         *EL FILE
%         PEP
...
%         the record key 411 as follows:
%         Column  1  -  Minimum principal plastic strain. 
%         Column  2  -  Etc.
...
ind = strfind(Rec,'I 3411D'); % record key for element principal plastic strains output (411)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 3411')+1;
...
for i=1:numel(ind)
    ...
    % Element principal plastic strains
    for j=1:NW(i)-2
