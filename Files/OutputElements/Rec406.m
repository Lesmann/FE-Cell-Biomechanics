function out = Rec406(Rec)
%
% ABAQUS principal mechanical strain rates output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec406(#Rec#)
%
% Description
%     Read principal mechanical strain rates output from the results
...
%     key for principal mechanical strain rates output is 406. See section
...
%     contain principal mechanical strain rate results:
%         ...
%         *FILE FORMAT, ASCII
%         *EL FILE
%         ERP
...
%         the record key 406 as follows:
%         Column  1  -  Minimum principal mechanical strain rate. 
%         Column  2  -  Etc.
...
ind = strfind(Rec,'I 3406D'); % record key for element principal mechanical strain rates output (406)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 3406')+1;
...
for i=1:numel(ind)
    ...
    % Element principal mechanical strain rates
    for j=1:NW(i)-2
        % principal mechanical strain rate
