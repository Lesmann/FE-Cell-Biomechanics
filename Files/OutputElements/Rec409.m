function out = Rec409(Rec)
%
% ABAQUS principal inelastic strains output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec409(#Rec#)
%
% Description
%     Read principal inelastic strains output from the results (*.fil) file
...
%     principal inelastic strains output is 409. See section < < Results file
...
%     contain principal inelastic strain results:
%         ...
%         *FILE FORMAT, ASCII
%         *EL FILE
%         IEP
...
%         the record key 409 as follows:
%         Column  1  -  Minimum principal inelastic strain. 
%         Column  2  -  Etc.
...
ind = strfind(Rec,'I 3409D'); % record key for element principal inelastic strains output (409)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 3409')+1;
...
for i=1:numel(ind)
    ...
    % Element principal inelastic strains
    for j=1:NW(i)-2
        % principal inelastic strain
