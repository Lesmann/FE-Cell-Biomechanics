function out = Rec35(Rec)
%
% ABAQUS saturation (pore pressure analysis) output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec35(#Rec#)
%
% Description
%     Read saturation (pore pressure analysis) output from the results
...
%     key for saturation output is 35 (only in ABAQUS/Standard). See
...
ind = strfind(Rec,'I 235D'); % record key for element saturation output (35)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 235')+1;
for i=1:numel(ind)
    % check ind
