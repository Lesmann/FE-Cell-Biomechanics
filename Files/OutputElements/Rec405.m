function out = Rec405(Rec)
%
% ABAQUS principal logarithmic strains output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec405(#Rec#)
%
% Description
%     Read principal logarithmic strains output from the results (*.fil)
...
%     principal logarithmic strains output is 405. See section < < Results
...
%     contain principal logarithmic strain results:
%         ...
%         *FILE FORMAT, ASCII
%         *EL FILE
%         LEP
...
%         the record key 405 as follows:
%         Column  1  -  Minimum principal logarithmic strain. 
%         Column  2  -  Etc.
...
ind = strfind(Rec,'I 3405D'); % record key for element principal logarithmic strains output (405)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 3405')+1;
...
for i=1:numel(ind)
    ...
    % Element principal logarithmic strains
    for j=1:NW(i)-2
