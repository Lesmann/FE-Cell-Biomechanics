function out = Rec401(Rec)
%
% ABAQUS principal stresses output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec401(#Rec#)
%
% Description
%     Read principal stresses output from the results (*.fil) file
...
%     principal stresses output is 401. See section < < Results file output
...
%     contain principal stress results:
%         ...
%         *FILE FORMAT, ASCII
%         *EL FILE
%         SP
...
%         the record key 401 as follows:
%         Column  1  -  Minimum principal stress. 
%         Column  2  -  Etc.
...
ind = strfind(Rec,'I 3401D'); % record key for element principal stresses output (401)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 3401')+1;
