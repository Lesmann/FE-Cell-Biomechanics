function out = Rec403(Rec)
%
% ABAQUS principal strains output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec403(#Rec#)
%
% Description
%     Read principal strains output from the results (*.fil) file
...
%     principal strains output is 403. See section < < Results file output
...
%     contain principal strain results:
%         ...
%         *FILE FORMAT, ASCII
%         *EL FILE
%         EP
...
%         the record key 403 as follows:
%         Column  1  -  Minimum principal strain. 
%         Column  2  -  Etc.
...
ind = strfind(Rec,'I 3403D'); % record key for element principal strains output (403)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 3403')+1;
