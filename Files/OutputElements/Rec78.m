function out = Rec78(Rec)
%
% ABAQUS whole element volume output to MATLAB
% 
% Syntax
%     #Rec# = Fil2str('*.fil');
%     #out# = Rec78(#Rec#)
%
% Description
%     Read whole element volume output from the results (*.fil) file
%     generated from the ABAQUS finite element software. The asterisk (*)
%     is replaced by the name of the results file. The record key for whole
%     element volume output is 78. See section < < Results file output
...
%     contain whole element volume results:
%         ...
%         *FILE FORMAT, ASCII
%         *EL FILE
%         EVOL
...
%         the record key 78 as follows:
%         Column  1  -  Current element volume. 
...
%         multiplied by the number of increments, and #m# is the number of
%         stress components of each element. If the results file does not
...
ind = strfind(Rec,'I 278D'); % record key for whole element volume output (78)
if isempty(ind)
    out=[];
    return;
end
nextpos=numel('I 278')+1;
