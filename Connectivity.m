...
% The product of the number of elements and the complement-to-1 of the desired level of connectivity (percentage from 8) - which would give the number of "weak" elements
NumOfWeakEl=round(lc*(1-loc)); 
