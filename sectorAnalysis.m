...
for l=1:length(filenames)
    ...
    %%% Identifying all element centroids falling within the area of interest
    k=1;
    ...
    for i=1:size(config.cells,1)
        ...
        offset_centroids_data_bycell{i}=sortrows(offset_centroids_data_bycell{i},8);
    end        
        
    %%% Identifying all element centroids falling within the relevant sectors
    numberofsectors=16;
